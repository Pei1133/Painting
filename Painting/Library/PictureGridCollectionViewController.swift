...
//        self.navigationItem.title = localTitle
    ...
    @objc func addNew() {
        ...
        guard let drawViewController = storyboard.instantiateViewController(withIdentifier: "Draw") as? DrawViewController else { return }

        drawViewController.isFill = false
